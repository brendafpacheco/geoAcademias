                        ...
                        service.getDetails(place, function (details, status) {
                            if (status === google.maps.places.PlacesServiceStatus
                                ...
                                btnInfo.addEventListener('click', function (e) {
                                    ...
                                    table.innerHTML = '<tr><td><strong>Nome</strong></td> <td>' + details.name + '</td> </tr><tr><td><strong>Endereço</strong></td> <td>' + details.formatted_address + '</td> </tr><tr><td><strong>Telefone</strong></td> <td>' + details.formatted_phone_number + '</td></tr>' + details.opening_hours.open + '</td></tr>' + '<button type="button" class="btn btn-primary btn-sm add">Adicionar à Lista</button>';
